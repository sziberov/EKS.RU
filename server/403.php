...
<tr><td valign="top" style="height: 29px;">
<?php include($_SERVER['DOCUMENT_ROOT'] . "/include/header.php"); ?>
</td></tr>
<tr><td valign="top" style="padding: 16px;" id="body_element">

<p><img src="/i/i_error.png" width="32" height="32" vspace="1" align="absmiddle">&nbsp;<big id="message">У Вас нет доступа к этой странице.</big>
</p><p>
&nbsp;
</p><p>
<span class="r_button"><a href="/">на титул</a></span>
