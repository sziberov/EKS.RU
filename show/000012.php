...
<meta name="title" content="ArtMoney v7.45.1 SE + Pro Portable by KloneB@DGuY">
...
<img id="poster" alt="ArtMoney v7.45.1 SE + Pro Portable by KloneB@DGuY" src="/<?php echo $key ?>/69566477.jpg" style="margin: 0 16px 8px 0; max-height: 512px; max-width: 512px;" title="ArtMoney v7.45.1 SE + Pro Portable by KloneB@DGuY" align="left" border="0">
<h1>ArtMoney v7.45.1 SE + Pro Portable by KloneB@DGuY</h1><br>
<small id="upload_time">27 марта 2017<span class="modify_time">, не редактировалось <!--<script src="/js/lastmodified.js">--></span></small>
<p>
</p>
<div id="post">
	<p id="main_info">
...
<tr>
	<?php $filepath = ("../" . $key . "/69566477.jpg"); $filename = end(explode('/', $filepath)); ?>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		...
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney.7.42.png");
...
<tr>
	<?php $filepath = ("../" . $key . "/ArtMoney.7.42.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
...
<tr>
	<?php $filepath = ("../" . $key . "/ArtMoney.7.42.1.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney.7.42.1.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney.7.42.2.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/ArtMoney.7.42.3.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney.7.42.3.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/ArtMoney.7.42.4.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney.7.42.4.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/artmoney745rus.zip"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/artmoney745rus.zip");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/ArtMoney Pro 7.45.1 Portable by KloneB@DGuY.zip"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ArtMoney Pro 7.45.1 Portable by KloneB@DGuY.zip");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
