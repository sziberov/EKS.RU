...
<meta name="title" content="Discord 31/Янв/2017">
...
<img id="poster" alt="Discord 31/Янв/2017" src="/<?php echo $key ?>/discord-icon.png" style="margin: 0 16px 8px 0;" title="Discord 31/Янв/2017" align="left" border="0" style="max-height: 512px; max-width: 512px;">
<h1>Discord 31/Янв/2017</h1><br>
<small id="upload_time">12 марта 2017<span class="modify_time">, не редактировалось <!--<script src="/js/lastmodified.js">--></span></small>
<p>
</p>
<div id="post">
	<p>
...
<tr>
	<?php $filepath = ("../" . $key . "/discord-icon.png"); $filename = end(explode('/', $filepath)); ?>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		...
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/discord-icon.png");
...
<tr>
	<?php $filepath = ("../" . $key . "/76716.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/76716.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/76717.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/76717.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/76718.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/76718.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/76719.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/76719.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/DiscordSetup31Jan2017.exe"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/DiscordSetup31Jan2017.exe");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
