...
<meta name="title" content="Google Chrome 55.0.2883.75 + 64bit">
...
<img id="poster" alt="Google Chrome 55.0.2883.75 + 64bit" src="/<?php echo $key ?>/icon.png" style="margin: 0 16px 8px 0;" title="Google Chrome 55.0.2883.75 + 64bit" align="left" border="0" style="max-height: 512px; max-width: 512px;">
<h1>Google Chrome 55.0.2883.75 + 64bit</h1><br>
...
<tr>
	<?php $filepath = ("../" . $key . "/icon.png"); $filename = end(explode('/', $filepath)); ?>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		...
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/icon.png");
...
<tr>
	<?php $filepath = ("../" . $key . "/ChromeStandaloneSetup55.0.2883.75.exe"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ChromeStandaloneSetup55.0.2883.75.exe");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/ChromeStandaloneSetup55.0.2883.75.64bit.exe"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/ChromeStandaloneSetup55.0.2883.75.64bit.exe");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
