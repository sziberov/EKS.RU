...
<meta name="title" content="Bandicam 3.3.2.1195 Repack by KpoJIuK">
...
<img id="poster" alt="Bandicam 3.3.2.1195 Repack by KpoJIuK" src="/<?php echo $key ?>/hAx69dTR-bandicam.png" style="margin: 0 16px 8px 0;" title="Bandicam 3.3.2.1195 Repack by KpoJIuK" align="left" border="0" style="max-height: 512px; max-width: 512px;">
<h1>Bandicam 3.3.2.1195 Repack by KpoJIuK</h1><br>
...
<tr>
	<?php $filepath = ("../" . $key . "/hAx69dTR-bandicam.png"); $filename = end(explode('/', $filepath)); ?>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		...
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/hAx69dTR-bandicam.png");
...
<tr>
	<?php $filepath = ("../" . $key . "/Bandicam.2.1.2.739.png"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/Bandicam.2.1.2.739.png");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/Bandicam.v3.3.2.1195.zip"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/Bandicam.v3.3.2.1195.zip");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
