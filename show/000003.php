...
<meta name="title" content="FastStone Capture 8.4 RePack (& Portable) by D!akov">
...
<img id="poster" alt="FastStone Capture 8.4 RePack (& Portable) by D!akov" src="/<?php echo $key ?>/0_13273f_5375e125_orig.jpg" style="margin: 0 16px 8px 0;" title="FastStone Capture 8.4 RePack (& Portable) by D!akov" align="left" border="0" style="max-height: 512px; max-width: 512px;">
...
<tr>
	<?php $filepath = ("../" . $key . "/0_13273f_5375e125_orig.jpg"); $filename = end(explode('/', $filepath)); ?>
	...
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		...
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/0_13273f_5375e125_orig.jpg");
...
<tr>
	<?php $filepath = ("../" . $key . "/9159146.jpg"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/9159146.jpg");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/9161194.jpg"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/9161194.jpg");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/9171434.jpg"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/9171434.jpg");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/9173482.jpg"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/9173482.jpg");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
...
<tr>
	<?php $filepath = ("../" . $key . "/FastStone Capture 8.4 RePack (& Portable) by D!akov).rar"); $filename = end(explode('/', $filepath)); ?>
	<td width="17"><img src="/i/i_disk.svg" border="0" height="17" width="17"></td>
	<td><span class="small"><script>document.write($('#file_list tbody tr').length - 1)</script>.</span><br><?php echo '<a id="file_name"'; if (file_exists($filepath)) { echo 'href="' . $filepath . '"'; } echo 'title="' . $filename . '"></a>'; ?></td>
		<?php include($root . "/include/file_info_php.php"); ?>
		<script>
			var url = new URL(window.location.origin + "/<?php echo $key ?>/FastStone Capture 8.4 RePack (& Portable) by D!akov).rar");
			<?php include($root . "/include/file_info_js.html"); ?>
		</script>
	</td>
</tr>
