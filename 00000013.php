...
<meta name="title" content="DAEMON Tools Lite 5.0.1.0407 RePack by KpoJIuK">
...
<img id="poster" alt="DAEMON Tools Lite 5.0.1.0407 RePack by KpoJIuK" src="/<?php echo $key ?>/DAEMON Tools Lite.png" style="margin: 0 16px 8px 0; max-height: 512px; max-width: 512px;" title="DAEMON Tools Lite 5.0.1.0407 RePack by KpoJIuK" align="left" border="0">
<h1 id="page_h1">DAEMON Tools Lite 5.0.1.0407 RePack by KpoJIuK</h1><br>
<small id="upload_time">1 апреля 2017<span class="modify_time">, не редактировалось <!--<script src="/js/lastmodified.js">--></span></small>
<p>
</p>
<div id="post">
	<p id="main_info">
		<b>Название:</b> DAEMON Tools Lite<br>
		<b>Версия:</b> 5.0.1.0407<br>
		<b>Лицензия:</b> freeware<br>
		<b>Интерфейс:</b> Многоязычный (English, Русский, Українська)<br>
		<b>Официальная страница:</b> <a href="http://www.daemon-tools.cc/rus/products/dtLite" rel="nofollow" target="_blank">daemon-tools.cc</a>
	</p>
	<p>
		<b>Описание:</b><br>
	...
	<p>
		...
		• Виртуализация приводов.<br>
		• Создание до 4-х виртуальных приводов (2 DT и 2 SCSI) для монтирования нескольких образов.<br>
	</p>
	<p>
		<b>Настройка виртуальных дисков:</b><br>
		• Изменение буквы диска, DVD региона и т.д.<br>
		• Монтирование *.mdx, *.mds/*.mdf, *.iso, *.b5t, *.b6t, *.bwt, *.ccd, *.cdi, *.bin/*.cue, *.ape/*.cue, *.nrg, *.pdi, *.isz образов на виртуальные приводы.<br>
	</p>
	<p>
		<b>Основные функции резервного копирования:</b><br>
		• Создание .iso, *.mds/*.mdf and *.mdx образов из CD/DVD/Blu-ray дисков.<br>
		• Защита образов паролем.<br>
		• Сжатие образов.<br>
		• Управление Каталогом образов.<br>
	</p>
	<p>
		...
		Вырезано: гаджет, прочие локализации<br>
		Дополнительно: подхват новых версий SPTD, настроек из файла Settings.reg<br>
	</p>
	<p>
		<b>Ключи командной строки:</b><br>
		Тихая установка русской версии: /S /RU<br>
		Тихая установка украинской версии: /S /UA<br>
		Тихая установка английской версии: /S /EN<br>
		Выбор места установки: /D=ПУТЬ<br>
		Ключ /D=ПУТЬ следует указывать самым последним<br>
		Например: Daemon.Tools.Lite.v4.47.1.0337.exe /S /RU /D=C:MyProgram<br>
	</p>
	<p>
		<b>Примечание:</b> <font color="#B22222"> В начале установки будет предложено изменить домашнюю страницу браузера. Не забудьте снять галочку.</font>
	</p>
</div>
